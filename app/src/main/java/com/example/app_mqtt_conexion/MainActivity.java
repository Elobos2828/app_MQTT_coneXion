...
//si el cliente esta desconectado se conecta falso=no conectado
    ...
    public  void  publicarD1 (View v) {
        String tema="el/01";///corrrespode al tema de LED
        String  menssage="1";
    ...
    public void publicarD3(View view) {
        String tema="el/02";///corrrespode al tema de LED
        String  menssage="1";
        publicaste= "publicaras " + tema + " " + menssage; //concatenamos el dato a publicar
        intento_publicar=true;//si intento publicar
        checar_conexion();//revisamos la conexion
    ...
    public void publicarD4(View view) {
    ...
    public void publicarD5(View view) {
        String tema="el/03";///corrrespode al tema de LED
        String  menssage="1";
        publicaste= "publicaras " + tema + " " + menssage; //concatenamos el dato a publicar
        intento_publicar=true;//si intento publicar
        checar_conexion();//revisamos la conexion
    ...
    public void publicarD6(View view) {
        String tema="el/03";///corrrespode al tema de LED
        String  menssage="0";
        publicaste= "publicaras " + tema + " " + menssage; //concatenamos el dato a publicar
        intento_publicar=true;//si intento publicar
    ...
    public void publicarD7(View view) {
        String tema="el/04";///corrrespode al tema de LED
        String  menssage="1";
        publicaste= "publicaras " + tema + " " + menssage; //concatenamos el dato a publicar
        intento_publicar=true;//si intento publicar
        checar_conexion();//revisamos la conexion
    ...
    public void publicarD8(View view) {
        String tema="el/04";///corrrespode al tema de LED
        String  menssage="0";
        publicaste= "publicaras " + tema + " " + menssage; //concatenamos el dato a publicar
        intento_publicar=true;//si intento publicar
